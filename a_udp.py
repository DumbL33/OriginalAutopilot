...
def main():
    ...
    # Lane segmentation and crossroad detection
    ...
    try:
        while True:
            ...
            if key == ord('q') or key == 27:
                ...
                sign_command = 'stop'
                car.set_beep(200)
                print("Car will stop at crossroad")
            elif key == ord('z'):
                if car_start:
                    car_start = False
                    car.set_beep(100)
            ...
            if action_command and in_parking_mode and not local_command_active and not yolo_command_active:
            ...
            should_move = car_start and not obstacle_detected and not should_stop_crossroad and not stop_sign_processing and not stopped_for_non_parking
