...
LSTM_ENGINE_PARK_FULL_3SEQ = 'models/tensorrt_lstm_full/best_lstm_steering_park_full_0.7_3seq.trt'
...
def main():
    ...
    try:
        while True:
            ...
            should_move = car_start and not obstacle_detected and not stop_sign_processing
